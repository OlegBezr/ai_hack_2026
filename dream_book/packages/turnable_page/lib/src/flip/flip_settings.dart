...
class FlipSettings {
  ...
  /// Color used to fill the book background and the opaque backing behind pages
  /// during a flip (anti-flicker fill) and for blank/padding leaves. Defaults to
  /// white. Set this to your page/paper color so blank pages and the moving
  /// leaf's backing blend with the spread instead of flashing stark white.
  ...
  // Legacy flags removed
    ...
    /// Background / paper fill color. Default: white (0xFFFFFFFF).
